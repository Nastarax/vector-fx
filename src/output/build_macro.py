...
<style>
  :root{
    ...
    --bullish:#3974e6; --bearish:#dd5050; --neutral:#5a6385;
    --accent:#4a7bff; --accent2:#6f9bff;
  ...
  *{box-sizing:border-box}
  ...
  header{display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;
    padding:18px 24px;background:linear-gradient(135deg,#1a2148 0%,#0d1430 100%);
  ...
  .brand h1{margin:0;font-size:13px;color:var(--muted);font-weight:500}
  nav{display:flex;align-items:center;gap:8px;flex-wrap:wrap}
  a.btn{color:#aac4ff;text-decoration:none;font-size:13px;border:1px solid var(--border);
    padding:6px 12px;border-radius:4px;background:var(--row);transition:background .15s}
...
<header>
  ...
  <nav>
    <span class="meta">Updated: __UPDATED_AT__</span>
    <a class="btn" href="output.html">&larr; Heatmap</a>
    <a class="btn" href="cot.html">COT</a>
    <a class="btn" href="economic_heatmap.html">Economic</a>
    <a class="btn" href="scorecard.html">Scorecard</a>
    <a class="btn" href="inflation.html">Inflation</a>
  </nav>
</header>
