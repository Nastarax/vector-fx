...
<style>
  :root {{
    ...
    --row:#1a2148; --rowAlt:#171d40; --border:#2a3168;
    --accent:#3974e6; --bullish:#3974e6; --bearish:#dd5050;
  }}
  *{{box-sizing:border-box}}
  body{{margin:0;background:var(--bg);color:var(--text);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Helvetica,Arial,sans-serif;padding:0}}
